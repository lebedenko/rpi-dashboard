...
Control {
    ...
    readonly property string statusText: root.statusKey === "online" ? qsTr("ONLINE") : root.statusKey === "registered" ? qsTr("REGISTERED") : root.statusKey === "stale" ? qsTr("STALE") : qsTr("OFFLINE")
    ...
    component UtilizationMetricCell: Item {
        ...
        Text {
            ...
            anchors.topMargin: 9
            text: parent.metricLabel
            textFormat: Text.PlainText
            color: Theme.textMuted
            font.family: Theme.fixedFontFamily
            font.pixelSize: Theme.metricLabelTextSize
    ...
    component DetailRow: Item {
        ...
        Text {
            anchors.left: parent.left
            anchors.leftMargin: Theme.detailIconRailWidth + 10
            anchors.verticalCenter: parent.verticalCenter
            width: 80
            text: parent.detailLabel
            textFormat: Text.PlainText
            color: Theme.textMuted
            font.family: Theme.fixedFontFamily
        ...
        Text {
            anchors.left: parent.left
            anchors.leftMargin: Theme.detailIconRailWidth + 94
            anchors.right: parent.right
            anchors.rightMargin: Theme.spacingSmall
            anchors.verticalCenter: parent.verticalCenter
            text: parent.detailValue
            textFormat: Text.PlainText
            color: Theme.textPrimary
            elide: Text.ElideRight
            font.family: Theme.sansFontFamily
            font.pixelSize: parent.valuePixelSize
    ...
    background: Item {
        Dashboard.Frame {
            id: outerFrame
            anchors.fill: parent
            anchors.margins: Theme.cardFrameInset
            Accessible.ignored: true
            backgroundColor: Theme.cardSurface
            color: Theme.cardFrame
            corners: ({
                    topLeft: {
                        chamfered: Theme.deviceFrameStep
                    },
                    topRight: {
        ...
        Rectangle {
            x: Theme.deviceFrameStep
            y: Theme.cardFrameInset
            width: Math.min(150, parent.width * 0.13)
            height: 2
            color: Theme.cardAccent
        }
        Rectangle {
            x: parent.width - width - Theme.deviceFrameStep
            y: parent.height - Theme.cardFrameInset - 2
            width: Math.min(128, parent.width * 0.11)
            height: 2
            color: Theme.cardAccent
        }
    }
    ...
    contentItem: Item {
        Item {
            ...
            Dashboard.Frame {
                ...
                x: 314
                anchors.verticalCenter: parent.verticalCenter
                width: Theme.statusBadgeWidth
                height: Theme.statusBadgeHeight
                Accessible.ignored: true
                backgroundColor: Theme.badgeSurface
            ...
            Item {
                ...
                UtilizationMetricCell {
                    ...
                    metricValue: root.cpuMetric
                    usageRatio: root.cpuUsageRatio
                    seriesColor: Theme.cpuSeries
                }
                UtilizationMetricCell {
                    id: memoryMetricCell
                    ...
                    width: parent.width * 0.28
                    height: parent.height
                    metricLabel: qsTr("MEM")
                    metricValue: root.memoryMetric
                    usageRatio: root.memoryUsageRatio
                    seriesColor: Theme.memorySeries
                }
                StackedMetricCell {
                    ...
                    height: parent.height
                    metricLabel: qsTr("TEMP")
                    metricValue: root.temperatureMetric
                    valueColor: Theme.cpuSeries
                }
                StackedMetricCell {
                    ...
                    height: parent.height
                    metricLabel: qsTr("UPTIME")
                    metricValue: root.uptimeMetric
                }
            }
            Button {
                id: chevron
                ...
                icon.source: Qt.resolvedUrl("icons/chevron.svg")
                icon.color: activeFocus ? Theme.focusAccent : Theme.cardAccent
                icon.width: 24
                icon.height: 24
                ...
                background: Dashboard.Frame {
                    ...
                    lineWidth: chevron.activeFocus ? 2 : 1
                    color: chevron.activeFocus ? Theme.focusAccent : Theme.passiveBorder
                    corners: ({
            ...
            Item {
                ...
                Item {
                    ...
                    Dashboard.Frame {
                        anchors.left: parent.left
                        anchors.top: parent.top
                        anchors.topMargin: Theme.detailHeaderHeight
                        anchors.bottom: parent.bottom
                        width: Theme.detailIconRailWidth
                        backgroundColor: Theme.detailRailSurface
                        color: Theme.detailRailFrame
                    }
                    DetailRow {
                        objectName: "detailRow0"
                        x: 0
                        y: Theme.detailHeaderHeight
                        width: parent.width
                        height: (parent.height - Theme.detailHeaderHeight) / 7
                        iconSource: Qt.resolvedUrl("icons/detail-os.svg")
                        detailLabel: qsTr("OS")
                        detailValue: root.osDescription
                    }
                    DetailRow {
                        objectName: "detailRow1"
                        x: 0
                        y: Theme.detailHeaderHeight + height
                        width: parent.width
                        height: (parent.height - Theme.detailHeaderHeight) / 7
                        iconSource: Qt.resolvedUrl("icons/detail-kernel.svg")
                        detailLabel: qsTr("KERNEL")
                        detailValue: root.kernelDescription
                    }
                    DetailRow {
                        objectName: "detailRow2"
                        x: 0
                        y: Theme.detailHeaderHeight + height * 2
                        width: parent.width
                        height: (parent.height - Theme.detailHeaderHeight) / 7
                        iconSource: Qt.resolvedUrl("icons/detail-arch.svg")
                        detailLabel: qsTr("ARCH")
                        detailValue: root.architecture
                    }
                    DetailRow {
                        objectName: "detailRow3"
                        x: 0
                        y: Theme.detailHeaderHeight + height * 3
                        width: parent.width
                        height: (parent.height - Theme.detailHeaderHeight) / 7
                        iconSource: Qt.resolvedUrl("icons/detail-hardware.svg")
                        detailLabel: qsTr("HARDWARE")
                        detailValue: root.hardwareDescription
                    }
                    DetailRow {
                        objectName: "detailRow4"
                        x: 0
                        y: Theme.detailHeaderHeight + height * 4
                        width: parent.width
                        height: (parent.height - Theme.detailHeaderHeight) / 7
                        iconSource: Qt.resolvedUrl("icons/detail-cpu.svg")
                        detailLabel: qsTr("PROCESSOR")
                        detailValue: root.cpuDescription
                    }
                    DetailRow {
                        objectName: "detailRow5"
                        x: 0
                        y: Theme.detailHeaderHeight + height * 5
                        width: parent.width
                        height: (parent.height - Theme.detailHeaderHeight) / 7
                        iconSource: Qt.resolvedUrl("icons/detail-cores.svg")
                        detailLabel: qsTr("CORES")
                        detailValue: root.coreDescription
                    }
                    DetailRow {
                        objectName: "detailRow6"
                        x: 0
                        y: Theme.detailHeaderHeight + height * 6
                        width: parent.width
                        height: (parent.height - Theme.detailHeaderHeight) / 7
                        iconSource: Qt.resolvedUrl("icons/detail-memory.svg")
                        detailLabel: qsTr("MEMORY")
                        detailValue: root.totalMemory
                    }
                }
                Rectangle {
                    id: bodyDivider
                    anchors.left: details.right
                    anchors.leftMargin: Theme.sectionGap / 2
                    anchors.top: parent.top
                    anchors.bottom: parent.bottom
                    width: 1
                ...
                Item {
                    ...
                    Row {
                        ...
                        Row {
                            spacing: 6
                            Rectangle {
                                objectName: "cpuHistoryLegendLine"
                                anchors.verticalCenter: parent.verticalCenter
                                width: 14
                                height: 2
                                color: Theme.cpuSeries
                            }
                            Text {
                                objectName: "cpuHistoryLegend"
                                text: qsTr("CPU %")
                                textFormat: Text.PlainText
                        ...
                        Row {
                            spacing: 6
                            Rectangle {
                                objectName: "memoryHistoryLegendLine"
                                anchors.verticalCenter: parent.verticalCenter
                                width: 14
                                height: 2
                                color: Theme.memorySeries
                            }
                            Text {
                                objectName: "memoryHistoryLegend"
                                text: qsTr("MEM %")
                                textFormat: Text.PlainText
                                color: Theme.chartText
                                font.family: Theme.fixedFontFamily
                    ...
                    Item {
                        ...
                        clip: true
                        anchors.fill: parent
                        anchors.leftMargin: Theme.plotLeftPadding
                        anchors.rightMargin: Theme.plotRightPadding
                        anchors.topMargin: Theme.plotTopPadding
                        anchors.bottomMargin: Theme.plotBottomPadding
                        Repeater {
                            model: 4
                            delegate: Rectangle {
                    ...
                    Repeater {
                        ...
                        delegate: Text {
                            ...
                            x: 0
                            y: Theme.plotTopPadding + index * (plot.height - height) / 4
                            width: Theme.plotLeftPadding - 6
                            horizontalAlignment: Text.AlignRight
                            text: String(100 - index * 25)
                            textFormat: Text.PlainText
                            color: Theme.chartText
                            font.family: Theme.fixedFontFamily
                            font.pixelSize: Theme.axisTextSize
                        }
                    }
                    Repeater {
                        ...
                        delegate: Text {
                            ...
                            x: timeLabel.index === 0 ? Theme.plotLeftPadding : timeLabel.index === 4 ? history.width - Theme.plotRightPadding - width : Theme.plotLeftPadding + timeLabel.index * plot.width / 4 - width / 2
                            y: history.height - height
                            text: timeLabel.modelData
                            textFormat: Text.PlainText
                            color: Theme.chartText
                            font.family: Theme.fixedFontFamily
                            font.pixelSize: Theme.axisTextSize
