...
FocusScope {
    ...
    function statusLabel(health): string {
        const labels = {"failed": qsTr("FAILED"), "attention": qsTr("ATTENTION"), "running": qsTr("RUNNING"),
    ...
    Keys.onUpPressed: event => { projectList.decrementCurrentIndex(); event.accepted = true }
    Keys.onDownPressed: event => { projectList.incrementCurrentIndex(); event.accepted = true }
    Keys.onSpacePressed: event => { root.selectCurrent(); event.accepted = true }
    ...
    Dashboard.Frame {
        ...
        backgroundColor: Theme.surface; color: Theme.cardFrame; lineWidth: 1
        corners: ({ chamfered: Theme.chamferMedium })
    }
    Item {
        id: headerBand
    ...
    Text {
        id: heading; objectName: "projectsHeading"
        anchors.left: headerBand.left; anchors.leftMargin: 12; anchors.verticalCenter: headerBand.verticalCenter
    ...
    Row {
        anchors.right: headerBand.right; anchors.rightMargin: 12; anchors.verticalCenter: headerBand.verticalCenter; spacing: 5
        Text { objectName: "trackedNumber"; color: Theme.textSecondary; font.family: Theme.fixedFontFamily; font.pixelSize: Theme.captionTextSize; font.weight: Theme.technicalRegularFontWeight; text: root.service ? root.service.trackedCount : "—" }
        Text { objectName: "trackedLabel"; color: Theme.textSecondary; font.family: Theme.sansFontFamily; font.pixelSize: Theme.captionTextSize; font.weight: Theme.labelFontWeight; text: qsTr("TRACKED") }
        Text { color: Theme.textMuted; font.family: Theme.sansFontFamily; font.pixelSize: Theme.captionTextSize; text: "·" }
        Text { objectName: "runningNumber"; color: root.service && root.service.runningCount > 0 ? Theme.primaryAccent : Theme.textSecondary; font.family: Theme.fixedFontFamily; font.pixelSize: Theme.captionTextSize; font.weight: Theme.technicalRegularFontWeight; text: root.service ? root.service.runningCount : "—" }
        Text { objectName: "runningLabel"; color: Theme.textSecondary; font.family: Theme.sansFontFamily; font.pixelSize: Theme.captionTextSize; font.weight: Theme.labelFontWeight; text: qsTr("RUNNING") }
        Text { color: Theme.textMuted; font.family: Theme.sansFontFamily; font.pixelSize: Theme.captionTextSize; text: "·" }
        Text { objectName: "failedNumber"; color: root.service && root.service.failedCount > 0 ? Theme.failureStatus : Theme.textSecondary; font.family: Theme.fixedFontFamily; font.pixelSize: Theme.captionTextSize; font.weight: Theme.technicalRegularFontWeight; text: root.service ? root.service.failedCount : "—" }
    ...
    Dashboard.Frame {
        ...
        backgroundColor: Theme.cardSurface; color: Theme.sectionDividerStrong; lineWidth: 1
    ...
    ListView {
        ...
        Accessible.role: Accessible.List; Accessible.name: qsTr("Projects")
        delegate: ItemDelegate {
            ...
            contentItem: Item {
                ...
                Row {
                    ...
                    anchors.right: parent.right; anchors.rightMargin: 12; anchors.top: parent.top; anchors.topMargin: 7
                    spacing: 6
                    Item {
    ...
    Dashboard.Frame {
        ...
        backgroundColor: Theme.surface; color: Theme.sectionDividerStrong; lineWidth: 1
        corners: ({ chamfered: Theme.chamferSmall })
    }
    Item {
        ...
        Row {
            ...
            Repeater {
                ...
                delegate: Item {
                    ...
                    Dashboard.Frame { objectName: "stageFrame" + stageCard.index; anchors.fill: parent; backgroundColor: Theme.cardSurface; color: stageCard.resolvedStatusColor; lineWidth: 1; corners: ({ chamfered: Theme.chamferSmall }) }
        ...
        Row {
            ...
            Repeater {
                model: [{"label": qsTr("DURATION"), "value": root.service ? root.available(root.service.duration) : "—"},
                        ...
                        {"label": qsTr("ARTIFACTS"), "value": root.service ? root.available(root.service.artifactSize) : "—"},
                        {"label": qsTr("DEPLOY"), "value": root.service ? root.available(root.service.deployStatus) : "—"}]
                delegate: Item {
                    id: metricCard
                    required property int index
                    required property var modelData
                    width: (metrics.width - Theme.spacingLarge) / 4; height: metrics.height
                    Dashboard.Frame { objectName: "metricFrame" + metricCard.index; anchors.fill: parent; backgroundColor: Theme.surfaceElevated; color: Theme.sectionDividerStrong; lineWidth: 1 }
        ...
        Text { id: historyHeading; objectName: "historyHeading"; anchors.left: parent.left; anchors.bottom: historyStrip.top; anchors.bottomMargin: 4; color: Theme.textSecondary; font.family: Theme.sansFontFamily; font.pixelSize: Theme.captionTextSize; font.weight: Theme.headingFontWeight; text: qsTr("RUN HISTORY (%1)").arg(root.service ? root.service.historyCount : 0) }
        Text { objectName: "historySummary"; anchors.right: parent.right; anchors.baseline: historyHeading.baseline; color: Theme.textSecondary; font.family: Theme.fixedFontFamily; font.pixelSize: Theme.captionTextSize; font.weight: Theme.technicalRegularFontWeight; text: qsTr("%1 / %2 SUCCESS").arg(root.service ? root.service.historySuccessfulCount : 0).arg(root.service ? root.service.historyCount : 0) }
        Row {
            id: historyStrip; objectName: "runHistoryStrip"
        ...
        Text {
            ...
            font.family: Theme.sansFontFamily; font.pixelSize: Theme.bodyTextSize; font.weight: Theme.informationFontWeight
        ...
        Text { anchors.right: parent.right; anchors.top: parent.top; visible: root.service && root.service.stale; color: Theme.staleStatus; font.family: Theme.sansFontFamily; font.pixelSize: Theme.captionTextSize; font.weight: Theme.headingFontWeight; text: qsTr("STALE · %1").arg(root.service.diagnostics) }
    }
}
